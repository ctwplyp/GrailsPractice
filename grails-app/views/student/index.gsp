		...
		<div id="list-student" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="referenceNumber" title="${message(code: 'student.referenceNumber.label', default: 'Reference Number')}" />
				...
				<g:each in="${studentInstanceList}" status="i" var="studentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: studentInstance, field: "referenceNumber")}</td>
